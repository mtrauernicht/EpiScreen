...
eff.data$sign <- "0_No"
eff.data$sign[eff.data$mean_eff_zscore_global_comb > 1 & eff.data$mean_eff_pval_adj_global_comb < 0.05] <- "1_Up"
eff.data$sign[eff.data$mean_eff_zscore_global_comb < -1 & eff.data$mean_eff_pval_adj_global_comb < 0.05] <- "2_Down"
