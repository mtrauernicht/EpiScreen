...
eff.data$sign <- "2_No"
eff.data$sign[eff.data$freqCut_norm_global_mean > 1.025 & eff.data$mean_eff_pval_adj_global_comb < 0.01] <- "1_Up"
eff.data$sign[eff.data$freqCut_norm_global_mean < 0.975 & eff.data$mean_eff_pval_adj_global_comb < 0.01] <- "0_Down"
