...
ggplot(indel.data %>%
              ...
              aes(y = -log10(mean_eff_pval_adj_global_comb), x = log2(freqCut_norm_global_mean), 
                  color = ifelse(mean_eff_pval_adj_global_comb < 0.01 & freqCut_norm_global_mean > 1.03, "green", 
                               ifelse(mean_eff_pval_adj_global_comb < 0.01 & freqCut_norm_global_mean < 0.97, "yellow","blue")))) +
  geom_quasirandom_rast() +
  geom_hline(linetype = "dashed", yintercept = -log10(0.01)) +
  geom_vline(linetype = "dashed", xintercept = log2(1.03)) +
  geom_vline(linetype = "dashed", xintercept = log2(0.97)) +
...
eff.data$sign <- "2_No"
eff.data$sign[eff.data$freqCut_norm_global_mean > 1.03 & eff.data$mean_eff_pval_adj_global_comb < 0.01] <- "1_Up"
eff.data$sign[eff.data$freqCut_norm_global_mean < 0.97 & eff.data$mean_eff_pval_adj_global_comb < 0.01] <- "0_Down"
