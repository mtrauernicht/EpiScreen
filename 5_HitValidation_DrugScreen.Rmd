...
annotation_colors_scr = list(
  LMNB1 = colorRampPalette(brewer.pal(n = 7, name = "PRGn"))(100),
  H3K27me3 = colorRampPalette(brewer.pal(n = 7, name = "PRGn"))(100),
  H3K36me3 = colorRampPalette(brewer.pal(n = 7, name = "PRGn"))(100),
  POL2 = colorRampPalette(brewer.pal(n = 7, name = "PRGn"))(100),
  H3K27ac = colorRampPalette(brewer.pal(n = 7, name = "PRGn"))(100),
  mean_ratio = colorRampPalette(brewer.pal(n = 7, name = "PRGn"))(100),
