...
# Annotate barcodes
annotate.bc <- 
  mapping_integration_long[grep("LAD_state|H3K27me3|H3K4me1|H3K27ac", 
                                             mapping_integration_long$variable),]
...
indel.data.high.drug <- melt(indel.data.high.drug)
indel.data.high.drug <- dcast(indel.data.high.drug, variable ~ barcode, value.var = "value")
setnames(target.high, old = "Drug", new = "variable")
indel.data.high.drug <- merge(indel.data.high.drug, target.high)
row.names(indel.data.high.drug) <- indel.data.high.drug$variable
indel.data.high.drug <- indel.data.high.drug[,-1]



data2 <- indel.data.high.drug[-grep("(activator)|Negative control|MRN|DNA-PK",indel.data.high.drug$Target),]
...
for (i in unique(data2$Target)) {
  ...
  p <- pheatmap(as.matrix(data[,1:18]), annotation_col = annotate.bc, 
         ...
         breaks = breaksList, annotation_legend = F,
...
col.target <- 
  c("navy", "darkgreen","yellow1","yellow2","yellow3","yellow4",
    "pink1","pink2","pink3","pink4","purple1","purple2","purple3",
    "purple4","orange1","orange2")
...
pheatmap(as.matrix(indel.data.high.target.st), annotation_col = annotate.bc, fontsize_row = 10, 
...
pheatmap(as.matrix(indel.data.high.target.st[-2,]), annotation_col = annotate.bc, fontsize_row = 10, 
         annotation_colors = annotation_colors, 
         color = colorRampPalette(rev(brewer.pal(n = 7, name = "PRGn")))(length(breaksList3)), 
         breaks = breaksList3,
         main = "log2(+1/-7 indel ratio), 
...
pheatmap(as.matrix(indel.data.med.target.st[-2,]), annotation_col = annotate.bc, fontsize_row = 10, 
         annotation_colors = annotation_colors, 
         color = colorRampPalette(rev(brewer.pal(n = 7, name = "PRGn")))(length(breaksList3)), 
         breaks = breaksList3,
         main = "log2(+1/-7 indel ratio), 
...
pheatmap(as.matrix(indel.data.low.target.st[-2,]), annotation_col = annotate.bc, fontsize_row = 10, 
         annotation_colors = annotation_colors, 
         color = colorRampPalette(rev(brewer.pal(n = 7, name = "PRGn")))(length(breaksList3)), 
         breaks = breaksList3,
         main = "log2(+1/-7 indel ratio), 
...
pheatmap(as.matrix(indel.data.high.target), annotation_col = annotate.bc, fontsize_row = 4, 
         annotation_colors = annotation_colors, 
         color = colorRampPalette(rev(brewer.pal(n = 7, name = "RdGy")))(length(breaksList)), 
         breaks = breaksList,
         main = "log2(+1/-7 indel ratio), 
...
# pheatmap function: logratio heatmap of target group vs. barcode - 1uM drugs added 
pheatmap(as.matrix(indel.data.med.target), annotation_col = annotate.bc, fontsize_row = 4,
         color = colorRampPalette(rev(brewer.pal(n = 7, name = "RdGy")))(length(breaksList)), 
         breaks = breaksList,
         annotation_colors = annotation_colors, main = "log2(+1/-7 indel ratio) - 
         1uM of drugs added")

# pheatmap function: logratio heatmap of target group vs. barcode - 100nM drugs added
pheatmap(as.matrix(indel.data.low.target), annotation_col = annotate.bc, fontsize_row = 4,
         color = colorRampPalette(rev(brewer.pal(n = 7, name = "RdGy")))(length(breaksList)), 
         breaks = breaksList,
         annotation_colors = annotation_colors, main = "log2(+1/-7 indel ratio) - 
         100nM of drugs added")
...
\newpage
## logratio heatmap of target group vs. barcode - no DNA-PKi
```{r}
...
pheatmap(as.matrix(indel.data.med.target[-2,]), annotation_col = annotate.bc, fontsize_row = 4,
         color = colorRampPalette(rev(brewer.pal(n = 7, name = "RdGy")))(length(breaksList)),
         breaks = breaksList,
         annotation_colors = annotation_colors, main = "log2(+1/-7 indel ratio) - 
...
pheatmap(as.matrix(indel.data.low.target[-2,]), annotation_col = annotate.bc, fontsize_row = 4,
         color = colorRampPalette(rev(brewer.pal(n = 7, name = "RdGy")))(length(breaksList)),
         breaks = breaksList,
         annotation_colors = annotation_colors, main = "log2(+1/-7 indel ratio) - 
...
pheatmap(as.matrix(indel.data.high.drug[,-19]), fontsize_col = 5, fontsize_row = 5, annotation_col = target, cellheight = 8,
