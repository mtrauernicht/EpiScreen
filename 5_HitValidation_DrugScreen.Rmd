...
mapping_mean <- get(load("mt20190225_mapping_mean"))
mapping_integration <- get(load("mt20190225_mapping_integration"))
indel.data <- get(load("mt20190222_indel.data"))
mapping_integration_long <- get(load("mt20190225_mapping_integration_long"))
mapping_mean_long <- get(load("mt20190225_mapping_mean_long"))
chip_dendogram <- get(load("mt20190225_chip_dendogram"))
```
...
myBreaks6 <- c(seq(min(as.matrix(indel.data.high.drug.ess)), 0, 
              ...
              seq(max(as.matrix(indel.data.high.drug.ess))/100, 
                  max(as.matrix(indel.data.high.drug.ess)), length.out=floor(100/2)))

# pheatmap function: without DNA-PKi: logratio heatmap of each individual drug vs. barcode - 10uM drugs added - include only drugs that achieve 2-fold change
indel.data.high.drug.ess <- indel.data.high.drug[,-42]
indel.data.high.drug.ess <- indel.data.high.drug.ess[, colSums(indel.data.high.drug.ess > 0.5) > 1 | colSums(indel.data.high.drug.ess < -0.5) >1] 
...
myBreaks7 <- c(seq(min(as.matrix(indel.data.med.drug.ess)), 0, 
              ...
              seq(max(as.matrix(indel.data.med.drug.ess))/100, 
                  max(as.matrix(indel.data.med.drug.ess)), length.out=floor(100/2)))


# pheatmap function: without DNA-PKi: logratio heatmap of each individual drug vs. barcode - 1uM drugs added- include only drugs that achieve 2-fold change
indel.data.med.drug.ess <- indel.data.med.drug[,-44]
indel.data.med.drug.ess <- indel.data.med.drug.ess[, colSums(indel.data.med.drug.ess > 0.5) > 1 | colSums(indel.data.med.drug.ess < -0.5) >1] 
...
myBreaks8 <- c(seq(min(as.matrix(indel.data.low.drug.ess)), 0, 
              ...
              seq(max(as.matrix(indel.data.low.drug.ess))/100, 
                  max(as.matrix(indel.data.low.drug.ess)), length.out=floor(100/2)))

# pheatmap function: without DNA-PKi: logratio heatmap of each individual drug vs. barcode - 100nM drugs added - include only drugs that achieve 2-fold change
indel.data.low.drug.ess <- indel.data.low.drug[,-48]
indel.data.low.drug.ess <- indel.data.low.drug.ess[, colSums(indel.data.low.drug.ess > 0.5) > 1 | colSums(indel.data.low.drug.ess < -0.5) >1]
...
# Keeping the scale in the pheatmap function
myBreaks8.51 <- c(seq(min(as.matrix(indel.data.high.eff.ess)), 0, 
                   length.out=ceiling(100/2) + 1), 
              seq(max(as.matrix(indel.data.high.eff.ess))/100, 
                  max(as.matrix(indel.data.high.eff.ess)), length.out=floor(100/2)))

# Efficiency change heatmap - 10 uM
indel.data.high.eff.ess <- indel.data.high.eff[,-42]
indel.data.high.eff.ess <- indel.data.high.eff.ess[, colSums(indel.data.high.eff.ess > 0.2) > 1 | colSums(indel.data.high.eff.ess < -0.1) >1]
...
# Keeping the scale in the pheatmap function
myBreaks9.5 <- c(seq(min(as.matrix(indel.data.med.eff.ess)), 0, 
                   length.out=ceiling(100/2) + 1), 
              seq(max(as.matrix(indel.data.med.eff.ess))/100, 
                  max(as.matrix(indel.data.med.eff.ess)), length.out=floor(100/2)))

# Efficiency change heatmap - 1 uM
indel.data.med.eff.ess <- indel.data.med.eff[,-44]
indel.data.med.eff.ess <- indel.data.med.eff.ess[, colSums(indel.data.med.eff.ess > 0.2) > 1 | colSums(indel.data.med.eff.ess < -0.1) >1]
...
pheatmap(as.matrix(indel.data.med.eff.ess), 
         ...
         annotation_colors = annotation_colors_scr, 
         main = "log2(efficiency) change - 1uM of drugs added")


# Keeping the scale in the pheatmap function
myBreaks10.5 <- c(seq(min(as.matrix(indel.data.low.eff.ess)), 0, 
                   length.out=ceiling(100/2) + 1), 
              seq(max(as.matrix(indel.data.low.eff.ess))/100, 
                  max(as.matrix(indel.data.low.eff.ess)), length.out=floor(100/2)))

# Efficiency change heatmap - 100 nM
indel.data.low.eff.ess <- indel.data.low.eff[,-48]
indel.data.low.eff.ess <- indel.data.low.eff.ess[, colSums(indel.data.low.eff.ess > 0.2) > 1 | colSums(indel.data.low.eff.ess < -0.1) >1]
...
pheatmap(as.matrix(indel.data.low.eff.ess), 
         ...
         annotation_colors = annotation_colors_scr, 
         main = "log2(efficiency) change - 100nM of drugs added")
```
...
```{r}
indel.data.high$logratio.platenorm.rel <- ave(indel.data.high$logratio.platenorm, FUN = function (x) x/max(x))
indel.data.high$efficiency.platenorm.rel <- ave(indel.data.high$efficiency.platenorm, FUN = function(x) x/max(x))
...
indel.data.overlay.high <- dcast(indel.data.overlay.high, Drug ~ barcode, value.var = "overlay")
...
# pheatmap function: t-statistic heatmap of each individual drug vs. barcode - 10uM drugs added
pheatmap(as.matrix(indel.data.overlay.high), fontsize_col = 8, fontsize_row = 8, cellheight = 8,
         annotation_row = annotate.bc,
         color = colorRampPalette(rev(brewer.pal(n = 7, name = "RdGy")))(100),
         breaks = myBreaks12.5,
         annotation_colors = annotation_colors_scr, main = "log2(+1/-7 indel ratio) - 10uM of drugs added")
```
...
# Process indel data
indel.data.chip <- indel.data[,c(1,3,6,23)]
setnames(chip_data, old = "variable", new = "barcode")
chip_data <- merge(indel.data.chip, mapping_mean, all = TRUE)
# 
# # Make df more sexy
