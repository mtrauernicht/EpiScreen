...
indel.data <- get(load("mt20190320_indel.data"))
...
indel.data.high.drug.ess <- 
  indel.data.high.drug.ess[, colSums(indel.data.high.drug.ess > 1.25) >= 1 | colSums(indel.data.high.drug.ess < -0.5) >= 1] 
# Keeping the scale in the pheatmap function
...
cor_chip_indel.high <- 
  cor_chip_indel.high[, 
                      colSums(cor_chip_indel.high > 0.666) >= 1 | 
                        colSums(cor_chip_indel.high < -0.666) >= 1]
...
cor_chip_indel.high.eff <- 
  cor_chip_indel.high.eff[, 
                      colSums(cor_chip_indel.high.eff > 0.666) >= 1 | 
                        colSums(cor_chip_indel.high.eff < -0.666) >= 1]

cor_chip_indel.med.eff <- 
  cor_chip_indel.med.eff[, 
                      colSums(cor_chip_indel.med.eff > 0.666) >= 1 | 
                        colSums(cor_chip_indel.med.eff < -0.666) >= 1]

cor_chip_indel.low.eff <- 
  cor_chip_indel.low.eff[, 
                      colSums(cor_chip_indel.low.eff > 0.666) >= 1 | 
                        colSums(cor_chip_indel.low.eff < -0.666) >= 1]
