...
colors <- brewer.pal(length(unique(barcode.order$cluster)), "Pastel2")
names(colors) <- unique(barcode.order$cluster)
...
vorino_model <- glm(MMEJ_diff~ H3K27me3, data = tib.model, family = 'binomial')
tib.model
