...
clone5.matrix = indel.data %>% select(IPR, ends_with(".zscore")) %>% distinct() %>%
...
all_compounds_epistasis = slope.features.tib %>% 
  select(drug, conc, ratio_slope_plot, feature, count_rate) %>%
