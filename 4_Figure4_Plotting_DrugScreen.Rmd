...
rank_dt = indel.data %>% 
  ...
  distinct(drug, conc_char, zscore_bal_global_comb_rep , target, cor_bal_FC, cor_bal, cor_bal_FC_filter, cor_bal_filter) %>% 
...
p3 = rank_dt %>%
  ...
  geom_point()  +
  scale_color_manual(values = colors_targets) +
  gghighlight(rank > maxrank-10 & cor_bal_FC_filter, label_key = drug_conc) +
  geom_hline(linetype = "dashed", yintercept = -2.58) +
