...
rank_dt = indel.data %>% 
  filter(drug != "DMSO" & pathway_bal_filter & viab_reproducibility, filter_zscore_bal_global_comb_rep) %>%
  distinct(drug, conc_char, zscore_bal_global_comb_rep , target, cor_bal, cor_bal_filter) %>% 
