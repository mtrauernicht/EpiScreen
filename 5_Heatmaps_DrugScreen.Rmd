...
indel.data.high.drug.ess <- indel.data.high.drug[, colSums(indel.data.high.drug > 1.5) >= 1 |
                            colSums(indel.data.high.drug < -0.5) >= 1]
# Keeping the scale in the pheatmap function
myBreaks2 <- c(seq(-0.5, 0, length.out=ceiling(100/2) + 1), 
...
indel.data.med.drug.ess <- indel.data.med.drug[, colSums(indel.data.med.drug > 1) >= 1 |
                            colSums(indel.data.med.drug < -0.7) >= 1] 
...
indel.data.low.drug.ess <- indel.data.low.drug[, colSums(indel.data.low.drug > 1) >= 1 |
                            colSums(indel.data.low.drug < -0.5) >= 1]
...
indel.data.high.eff.ess <- indel.data.high.eff[, colSums(indel.data.high.eff > 0.08) >= 1 |
                            colSums(indel.data.high.eff < -0.2) >= 1]
...
indel.data.med.eff.ess <- indel.data.med.eff[, colSums(indel.data.med.eff > 0.0666) >= 1 | 
                           colSums(indel.data.med.eff < -0.1333) >= 1]
...
indel.data.low.eff.ess <- indel.data.low.eff[, colSums(indel.data.low.eff > 0.0666) >= 1 |
                           colSums(indel.data.low.eff < -0.1333) >= 1]
