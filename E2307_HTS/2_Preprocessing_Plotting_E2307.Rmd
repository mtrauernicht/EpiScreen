...
CCD_tib <- readRDS("/DATA/projects/DSBrepair/data/R/rs20230921_episcreen/mt20231005_CCD_table_0.RDS")
...
CCD_tib_k562 <- readRDS("/DATA/projects/DSBrepair/data/R/rs20230424_episcreen/rs20230424_CCD_table_0.RDS") %>%
  filter(drug_conc %in% c("Tubastatin A 10 µM", "PCI-24781 100 nM", "AT9283 100 nM")) %>%
  dplyr::select("drug" = drug_conc, "k562_slope" = indelrate_slope_plot, feature) %>%
  na.omit() %>%
  filter(!feature %in% c("HDAC3", "CTCF", "SMC3"))
