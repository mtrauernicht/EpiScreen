...
---
```{r Fig2A chromideograms, fig.height=5, fig.width=6}
p1 = ggplot() +
...
clone5_map_ipr = dendextend::rotate(hclust(dist(chrom_matrix)), c(1:2,5:8,3:4, 15:14, 17, 16, 18 ,13,10:12,9))
...
pheatmap(chrom_matrix[TRIP_chrom_clust$labels,], 
