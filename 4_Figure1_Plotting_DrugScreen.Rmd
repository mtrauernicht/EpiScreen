...
```{r 1EG TIF, warning = FALSE, fig.height=5, fig.width=6} 
...
```{r 1FH MMEJ ratio, warning = FALSE, fig.height=5, fig.width=6}
...
```{r S1H TIF zscores per IPR, warning = FALSE, fig.height=3, fig.width=5}
...
```{r S1I bal zscore per IPR, warning = FALSE, fig.height=3, fig.width=5}
  ggplot(zscore_dt,
