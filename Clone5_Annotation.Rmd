...
pheatmap(as.matrix(mapping_mean_essent), annotation_col = LAD_integration, 
         ...
         annotation_colors = annotation_colors, main = "RSTP2#5: chromatin mark intensity per barcode")
...
## Create heatmaps: mapping_integration
```{r}
# Average repetitive ChIP datasets & remove duplets
...
## Only essentials
mapping_integration_essent <- mapping_integration[,c("LMNB1","EZH2","H3K79me2","H3K9me3","H3K9me2","H3K122ac","H3K27ac","H3K4me1","H3K27me3","H3K36me3","POL2")]

# Preprocess dataset for heatmap
mapping_integration$LAD_state[is.na(mapping_integration$LAD_state)] <- 0
row.names(mapping_integration) <- mapping_integration$barcode
...
# Generate heatmap
pheatmap(as.matrix(mapping_integration), annotation_col = chromatin.mark_type3, 
         annotation_colors = annotation_colors_2, main = "RSTP2#5: chromatin integration state per barcode")
