...
## S2B Vorinostat TIF FC correlation with chromatin features
```{r S2B Vorino TIF FC Correlations, fig.width= 8, fig.height= 8}
## Vorinostat
...
## S2C GSK TIF FC correlation with chromatin features
```{r S2C GSK TIF FC Correlations, fig.width= 8, fig.height= 8}
## GSK126
...
## S2extra Vorinostat per cluster
```{r S2extra Vorino density, fig.height=5, fig.width=7}
vorino.dt = vorino.dt %>% 
...
## S2extra Vorinostat per cluster
```{r S2extra GSK density, fig.height=5, fig.width=7}
...
```{r S2_ Correlation of log2 FC TIF}
