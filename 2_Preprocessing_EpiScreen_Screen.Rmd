...
serialNext = function(prefix, extension){
  file_name = paste(prefix, extension, sep = ".")
  if(!file.exists(file_name)){return(paste(prefix, extension, sep = "."))}
    i=1
    repeat {
...
filename <- SetFileName("_episcreen_mutations", initials = initials, extension = "RDS")
saveRDS(screen.indels.chrom.dt, file = filename)

# The ratios list of the split technical replicates
filename <- SetFileName("_episcreen_ratios", initials = initials, extension = "RDS")
