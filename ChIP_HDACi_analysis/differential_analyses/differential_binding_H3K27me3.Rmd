---
title: <font color="#ff8000">**GCF-7637 - Differential H3K27me3 - K562 treated with HDAC inhibitors**</font>
...
```
```
K562_H3K27me3_DMSO_rep1 K562 H3K27me3 DMSO  1 narrow
K562_H3K27me3_DMSO_rep2 K562 H3K27me3 DMSO  2 narrow
K562_H3K27me3_DMSO_rep3 K562 H3K27me3 DMSO  3 narrow
K562_H3K27me3_PCI_rep1 K562 H3K27me3 PCI  1 narrow
K562_H3K27me3_PCI_rep2 K562 H3K27me3 PCI  2 narrow
K562_H3K27me3_PCI_rep3 K562 H3K27me3 PCI  3 narrow
K562_H3K27me3_Tuba_rep1 K562 H3K27me3 Tuba  1 narrow
K562_H3K27me3_Tuba_rep2 K562 H3K27me3 Tuba  2 narrow
K562_H3K27me3_Tuba_rep3 K562 H3K27me3 Tuba  3 narrow
```
...
Applying blacklist...
Removed: 1691 of 1324217 intervals.
Removed: 674 merged (of 311198) and 85 (of 121802) consensus.
```
...
### Plot MA
```{r DB_diff_MAplot, fig.align='center', fig.height=5, fig.width=5, warning=FALSE}
for (i in 1:length(constrast_list)) {
...
### Plot volcano
```{r DB_diff_volcano, fig.align='center', fig.height=5, fig.width=5, warning=FALSE}
for (i in 1:length(constrast_list)) {
...
### Plot PCA
```{r PCA_diff, fig.align='center', fig.height=5, fig.width=5, warning=FALSE}
for (i in 1:length(constrast_list)) {
