...
eff.data <- indel.data %>%
  ...
  distinct(conc_char, drug, target, IPR, zscore_TIF_comb_rep, freqCut_diff_mean, replicate, tech, filter_zscore_TIF_comb_rep,filter_zscore_TIF_comb_tech, zscore_TIF)
...
```{r S3C Example PCR prediction, fig.width = 6, fig.height = 6}
...
# adj_p.value_KO_model %>% filter(drug_conc %in% c("BMN 673 10 µM", "Apicidin 100 nM"), var == "log2.fc.freqCut")
# BMN 673 10 µM : 0.1697062666
# Apicidin 100 nM : 0.0001259269
```


## S3EF Example CCDs
```{r S3C Example strong synergy hits with LMNB1,  fig.width = 6, fig.height = 4}
