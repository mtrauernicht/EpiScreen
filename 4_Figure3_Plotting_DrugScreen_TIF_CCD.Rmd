...
pool_validation_ratios = bind_rows(filter(vorinostat_ratios,efficiency_DMSO < .85),  filter(GSK_ratios, efficiency_DMSO_GSK < 0.85)) %>% 
...
vorino_k27 = bind_rows(vorino_screen_K27, vorino_pool_K27)

pdf("/DATA/projects/DSBrepair/git/EpiScreen/figures/rs20220824_validation_poo_max85TIFl.pdf", height = 10, width = 10)
