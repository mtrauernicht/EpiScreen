...
slope.colors <- tibble(color = c("grey50", "#f5f5f5","#84a98c"),label = c("negative","none","positive"), feature = "epistasis")
...
CCD_example_tib = indel.data %>% 
  ...
  distinct(IPR, drug, freqCut, H3K27me3.zscore, LMNB1.zscore, m5C.zscore, HDAC1.zscore, tech, replicate, H3K36me3.zscore) %>%
  mutate(freqCut_mean = ave(freqCut, IPR, drug, FUN = mean)) %>%
  distinct(IPR, drug, freqCut_mean, H3K27me3.zscore, LMNB1.zscore, m5C.zscore, HDAC1.zscore, H3K36me3.zscore) %>%
