...
indel.data <- readRDS("/DATA/projects/DSBrepair/data/R/rs20210813_episcreen/rs20210813_episcreen_ratios.RDS")
indel.data.split <- readRDS("/DATA/projects/DSBrepair/data/R/rs20210813_episcreen/rs20210813_episcreen_ratios_split.RDS")
indel.data.mut <- readRDS("/DATA/projects/DSBrepair/data/R/rs20210813_episcreen/rs20210813_episcreen_mutations.RDS")

# Complete data without exlcluding wells <0.5 viability (I need this for plotting)
viability.data = as.data.table(readRDS("/DATA/projects/DSBrepair/git/EpiScreen/files_scripts/rs20210626_Episcreen_Reads_Viab_Metadata.RDS")) %>%
  dplyr::select(ID, drug, target, replicate, viab_norm, conc_char, tech)
```
