...
output.file <- "/DATA/usr/m.trauernicht/projects/EpiScreen/E2159/mt20230213_TIDE_LBR.pdf"
folder <- ""
seqstart = 65
seqend = 225
maxshift = 10
...
output.file <- "/DATA/usr/m.trauernicht/projects/EpiScreen/E2159/mt20230213_TIDE.pdf"
folder <- ""
seqstart = 200
seqend = 450
maxshift = 10
...
percentage_df <- percentage_df %>%
  ...
  mutate(replicate = gsub(".*(r[1-3])", "\\1", sample)) %>%
