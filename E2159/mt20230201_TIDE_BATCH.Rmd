...
output.file <- "/DATA/usr/m.trauernicht/projects/EpiScreen/E2159/mt20230317_TIDE_LBR.pdf"
folder <- ""
seqstart = 65
seqend = 225
maxshift = 10
...
output.file <- "/DATA/usr/m.trauernicht/projects/EpiScreen/E2159/mt20230317_TIDE.pdf"
folder <- ""
seqstart = 200
seqend = 450
maxshift = 10
...
## Annotate dataframe
percentage_df <- percentage_df %>%
  mutate(condition = gsub("_r[1-5]", "", sample)) %>%
  mutate(replicate = gsub(".*(r[1-5])", "\\1", sample)) %>%
