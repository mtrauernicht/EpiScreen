...
RSTP2_2000_indels.df$.id <- gsub("(.*?).count.table", "\\1", 
...
RSTP2_2000_indels.df$conc <- gsub("_rep.*", "\\1", 
                                         RSTP2_2000_indels.df$.id)
RSTP2_2000_indels.df$Number <- gsub(".*plate.*_(.*?_.*?)","\\1", RSTP2_2000_indels.df$.id)
...
decitabine.rep3 <- RSTP2_2000_indels.df[RSTP2_2000_indels.df$Drug == "Decitabine" & RSTP2_2000_indels.df$rep == "3",]
decitabine <- RSTP2_2000_indels.df[RSTP2_2000_indels.df$Drug == "Decitabine",]
decitabine2 <- decitabine[,c(-6:-100)]
